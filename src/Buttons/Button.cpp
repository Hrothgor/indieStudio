...
void IS::Button::scene0Button()
{
    IS::GLOBAL::_scene = 0;
}

void IS::Button::scene1Button()
{
    IS::GLOBAL::_scene = 1;
}

void IS::Button::scene2Button()
{
    IS::GLOBAL::_scene = 2;
    GLOBAL::camera->startAnimation({-200, 500, 100}, {60, 120, 130}, {60, 0, 50}, 5);
    GLOBAL::_bombermans.at(0)->setPosition({10, 0, 10});
    GLOBAL::_bombermans.at(1)->setPosition({110, 0, 10});
    GLOBAL::_bombermans.at(2)->setPosition({10, 0, 110});
    GLOBAL::_bombermans.at(3)->setPosition({110, 0, 110});
}
